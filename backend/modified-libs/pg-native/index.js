...
var Client = (module.exports = function (config) {
  ...
  this._firstRowReadTiming = undefined;
...
Client.prototype._read = function () {
  ...
  this._firstRowReadTiming = performance.now();
...
Client.prototype._onReadyForQuery = function () {
  ...
  // reset _firstRowReadTiming value
  const firstRowReadTiming = this._firstRowReadTiming;
  this._firstRowReadTiming = undefined;

  // reset _firstRowReadTiming value
  const rowsTiming = this._rowsTiming;
  this._rowsTiming = undefined;
