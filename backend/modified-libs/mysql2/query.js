...
class Query extends Command {
  ...
  start(_packet, connection) {
    ...
    if (this.onResult) {
      let rows, rowsTiming, fields;
      if (this._resultIndex === 0) {
        rows = this._rows[0];
        rowsTiming = this._rowsTiming[0];
      ...
      if (fields) {
        ...
        process.nextTick(() => {
          this.onResult(null, rows, undefined, {
            rowsTiming,
          });
        });
      }
  ...
  row(packet, _connection) {
    ...
    if (this.onResult) {
      ...
      if (this._rowIndex === 1 || this._rowIndex % 1000 === 0) {
        this._rowsTiming[this._resultIndex].push({
